...
<div class="panel-display panel-2col-bricks clearfix" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
	...
	<?php if ($content['top']) : ?>
  <div class="panel-panel panel-col-top page-header">
    <div class="inside"><?php print $content['top']; ?></div>
  </div>
  <?php endif; ?>

	<?php if ($content['left_above']) : ?>
  <div class="panel-panel panel-col-first top-row-content">
  ...
  <div class="panel-panel panel-col-last bottom-row-right-rail">
