<?php
/**
 * This file is for the configuration of IMCE.
 * 
 * It is placed in the theme template directory to avoid accidental overwrite
 * during the module upgrade process.
 * 
 * @author Rob Davison
 * 
 */
...
<!--//--><![CDATA[//><!--
  ...
  imce.vars.tMaxW = 10240; //maximum width of an image to be previewed inline
  imce.vars.tMaxH = 10240; //maximum height of an image to be previewed inline
  imce.vars.prvW = 100; //maximum width of the thumbnail used in inline preview.
  imce.vars.prvH = 100; //maximum height of the thumbnail used in inline preview.
  //imce.vars.prvstyle = 'media_thumbnail'; //preview larger images inline using an image style(imagecache preset).
  ...
  imce.vars.boxW = 128; //width of a file info box
  imce.vars.boxH = 128; //height of a file info box
